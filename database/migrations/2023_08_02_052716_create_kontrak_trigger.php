...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        FOR EACH ROW
        INSERT INTO kontraks (no_induk_karyawan, nama_karyawan, email, jenis_kelamin, tanggal_lahir, 
        no_kontrak_perusahaan, tanggal_kontrak_awal, tanggal_kontrak_akhir,
        status_kontrak, status_pensiun)
        VALUES
        (NEW.no_induk_karyawan, NEW.nama_karyawan, NEW.email, NEW.jenis_kelamin, NEW.tanggal_lahir,
